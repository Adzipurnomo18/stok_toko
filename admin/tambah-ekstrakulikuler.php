					...
					<div class="box-body">
						 <form action="" method="POST" enctype="multipart/form-data">
						 	...
						 	<div class="form-group">
						 		<label>Nama</label>
						 		<input type="text" name="nama" placeholder="Nama Ektrakulikuler" class="input-control" required>
						 	</div>
						 	<div class="form-group">
						 ...
						 <?php 
						 	if(isset($_POST['submit'])){
						 		...
						 		if(!in_array($formatfile, $allowedtype)){
						 			...
						 			$simpan = mysqli_query($conn, "INSERT INTO ekstrakulikuler VALUES (
								 			null,
								 			'".$nama."',
								 			'".$ket."',
								 			'".$rename."',
